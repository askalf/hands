...
<p align="center">
  ...
  <a href="https://scorecard.dev/viewer/?uri=github.com/askalf/hands"><img src="https://api.scorecard.dev/projects/github.com/askalf/hands/badge" alt="OpenSSF Scorecard"></a>
...
| **Release attestation** | Publishing is tokenless: npm OIDC trusted publishing bound to `publish.yml` — no long-lived NPM_TOKEN exists to leak or rot. Every npm publish carries a SLSA provenance attestation generated by GitHub Actions. Verifiable via `npm audit signatures @askalf/hands`. |
| **Telemetry** | None. |
| **License** | MIT |
